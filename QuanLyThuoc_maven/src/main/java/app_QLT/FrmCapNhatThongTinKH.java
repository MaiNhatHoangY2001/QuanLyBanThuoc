...
public class FrmCapNhatThongTinKH extends JFrame {
	...
	public FrmCapNhatThongTinKH(KhachHang kh) {
		...
		btnLoc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				KhachHang khachhang = getThongTinKhachHang();
		...
		lblTitle.setBounds(172, 30, 655, 73);
		pnlXanh.add(lblTitle);

		loadThongTinKhachHang(kh);

	}

	public void loadThongTinKhachHang(KhachHang kh) {
		txtTen.setText(kh.getHoTen());
		txtDiaChi.setText(kh.getDiaChi());
		txtSDT.setText(kh.getSDT());
		radNam.setSelected(kh.isGioiTinh());
		setDate(kh.getNgaySinh());
	}
	...
	public void setDate(LocalDate d) {
		cmbNgay.setSelectedItem(d.getDayOfMonth() + "");
		cmbThang.setSelectedItem("Tháng " + d.getMonthValue());
		cmbNam.setSelectedItem(d.getYear() + "");
	}
}
