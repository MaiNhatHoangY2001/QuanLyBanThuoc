...
public class AppServer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Naming.bind("rmi://192.168.1.7:9999/ctHoaDon_DAO", ctHoaDon_DAO);
			Naming.bind("rmi://192.168.1.7:9999/hoaDonDao", hoaDonDao);
			Naming.bind("rmi://192.168.1.7:9999/khachHangDao", khachHangDao);
			Naming.bind("rmi://192.168.1.7:9999/loaiThuocDao", loaiThuocDao);
			Naming.bind("rmi://192.168.1.7:9999/nhaCungCapDao", nhaCungCapDao);
			Naming.bind("rmi://192.168.1.7:9999/nhanVienDao", nhanVienDao);
			Naming.bind("rmi://192.168.1.7:9999/nuocDao", nuocDao);
			Naming.bind("rmi://192.168.1.7:9999/thuocDao", thuocDao);
